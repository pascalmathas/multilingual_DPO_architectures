#!/bin/bash
#
# Runs translation for multiple language pairs using DPO 'chosen' data.
#
...
OUTPUT_DIR="${PROJECT_ROOT}/translations/x-alma-13b-multi-dpo-chosen"
DATA_PATH="${PROJECT_ROOT}/data/DPO_json/chosen"
...
# --- Main Execution ---
echo "Starting DPO 'chosen' translations..."
