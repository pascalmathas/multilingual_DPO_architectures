#!/bin/bash
#
# Runs translation for multiple language pairs using DPO 'prompt' data.
#
...
OUTPUT_DIR="${PROJECT_ROOT}/translations/x-alma-13b-multi-dpo-prompt"
DATA_PATH="${PROJECT_ROOT}/data/DPO_json/prompt"
ACCELERATE_CONFIG="${PROJECT_ROOT}/configs/deepspeed_eval_config_bf16.yaml"
RUN_SCRIPT="${PROJECT_ROOT}/run_llmmt.py"

# Add language pairs to this array.
TEST_PAIRS_ARRAY=("en-de" "en-nl" "en-is")
...
# --- Main Execution ---
echo "Starting DPO 'prompt' translations..."
