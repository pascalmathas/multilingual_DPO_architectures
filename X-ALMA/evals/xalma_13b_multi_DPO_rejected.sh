#!/bin/bash
#
# Runs translation for multiple language pairs using DPO 'rejected' data.
#
...
OUTPUT_DIR="${PROJECT_ROOT}/translations/x-alma-13b-multi-dpo-rejected"
DATA_PATH="${PROJECT_ROOT}/data/DPO_json/rejected"
...
# --- Main Execution ---
echo "Starting DPO 'rejected' translations..."
